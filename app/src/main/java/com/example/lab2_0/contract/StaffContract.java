...
public class StaffContract {
    ...
    public static class InfoEntry implements BaseColumns {
        ...
        public static final String AUTHORITY = "com.example.lab2_0.helper.MyContentProvider";
    }
    ...
    public static ContentValues getSqlInsert(String name, String gender, String department, String salary) {
